              ...
              <div className="flex items-start gap-3 bg-navy-light rounded-xl p-3">
                ...
                <div>
                  <p className="text-white text-xs font-semibold mb-0.5">
                    Tap the <Share className="w-3 h-3 inline-block mx-1 text-accent" /> icon in Safari Browser
                  </p>
                  <p className="text-text-muted text-xs">
                    It is the share icon with an upward arrow at the <span className="text-white font-semibold">bottom centre</span> of your <b>Safari</b> browser.
                  </p>
                </div>
              </div>
